...
const path = require('path'); //  ilgili html dosyalarına  ulaşmak için path modülünü çağıralıyoruz
...
// ################## template engine ejs #################
/*Template Engine ,EJS modülü template dosyaları görebilmek için varsayılan olarak views klasörünün içerisindeki .ejs uzantılı dosyalara bakar*/
...
// #################### action yönlendermek için postrequest #############
